		...
		case GLFW_PRESS:
			switch(key)
			{
				...
				case GLFW_KEY_D:
					...
					break;
				case GLFW_KEY_1:
					input->set_button_state(Button::ShowOne, Button_State::PRESSED);
					break;
				case GLFW_KEY_2:
					input->set_button_state(Button::ShowTwo, Button_State::PRESSED);
					break;
				case GLFW_KEY_3:
					input->set_button_state(Button::ShowThree, Button_State::PRESSED);
					break;
				case GLFW_KEY_4:
					input->set_button_state(Button::ShowFour, Button_State::PRESSED);
					break;
				case GLFW_KEY_5:
					input->set_button_state(Button::ShowFive, Button_State::PRESSED);
					break;
				case GLFW_KEY_6:
					input->set_button_state(Button::ShowSix, Button_State::PRESSED);
					break;
			}
			break;
		...
		case GLFW_RELEASE:
			switch(key)
			{
				...
				case GLFW_KEY_D:
					...
					break;
				case GLFW_KEY_1:
					input->set_button_state(Button::ShowOne, Button_State::RELEASED);
					break;
				case GLFW_KEY_2:
					input->set_button_state(Button::ShowTwo, Button_State::RELEASED);
					break;
				case GLFW_KEY_3:
					input->set_button_state(Button::ShowThree, Button_State::RELEASED);
					break;
				case GLFW_KEY_4:
					input->set_button_state(Button::ShowFour, Button_State::RELEASED);
					break;
				case GLFW_KEY_5:
					input->set_button_state(Button::ShowFive, Button_State::RELEASED);
					break;
				case GLFW_KEY_6:
					input->set_button_state(Button::ShowSix, Button_State::RELEASED);
					break;
			}
			break;
