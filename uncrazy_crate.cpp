...
Uncrazy_Crate::Uncrazy_Crate(const char* id)
	: Game_Object(id)
{
	_translation.x += 12.f;
...
Uncrazy_Crate::~Uncrazy_Crate()
{
}

void Uncrazy_Crate::simulate_AI(const double, const Assets*, const Scene*, const Configuration*, const Input*)
{
}
void Uncrazy_Crate::render(const double seconds_to_simulate, const Assets* assets, const Scene* scene, const Configuration* config)
{
